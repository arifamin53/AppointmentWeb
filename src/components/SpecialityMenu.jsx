...
const SpecialityMenu = () => {
  ...
  return (
    <div id='speciality' className='flex flex-col  items-center gap-4 py-16 text-gray-600'>
        <h1 className='text-3xl font-medium'>Find BySpeciality</h1>
        <p className='w-1/3 text-sm text-center'>simply browse through our extensive list of trusted doctors,shedule your appointment hassle-free.</p>
